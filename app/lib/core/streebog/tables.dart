// Matrix A для L-преобразования
const List<int> MATRIX_A = [
  0x8e20faa72ba0b470,
  0x47107ddd9b505a38,
  0xad08b0e0c3282d1c,
  0xd8045870ef14980e,
...
const List<int> P = [
  ...
  45, 43, 9, 91, 203, 155, 37, 208, 190, 229, 108, 82, 89, 166, 116, 210,
  230, 244, 180, 192, 209, 102, 175, 194, 57, 75, 99, 182,
];

// Таблица перестановки байт T
const List<int> T = [
...
// Итерационные константы C (12 элементов)
const List<List<int>> C = [
  [
   ...
   const List<int> S_BOX = [
    
  ];
...
/// Inverse S-Box (Reverse Pi)
const List<int> KUZ_PI_INV = [
